"""
Django settings for round_truth_dev_82085 project.
...
ROOT_URLCONF = 'round_truth_dev_82085.urls'
...
WSGI_APPLICATION = 'round_truth_dev_82085.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_truth_dev_82085 API",
    "DESCRIPTION": "API documentation for round_truth_dev_82085 App",
    "VERSION": "v1",
}
